...
pub = rospy.Publisher('pioneer1/action', Int8, queue_size=1)
rospy.init_node('pioneer1/policy', anonymous=True)

scout_1 = NEAT.NeuralNetwork()
is_success = scout_1.Load('Best_team/Scout_0')
...
def listener():
    rospy.Subscriber('pioneer1/full_state', RoverState, callback)
    rospy.spin()
