...
pub = rospy.Publisher('pioneer2/action', Int8, queue_size=1)
rospy.init_node('pioneer2/policy', anonymous=True)

scout_1 = NEAT.NeuralNetwork()
is_success = scout_1.Load('Best_team/Service_bot_0')
...
def listener():
    rospy.Subscriber('pioneer2/full_state', RoverState, callback)
    rospy.spin()
