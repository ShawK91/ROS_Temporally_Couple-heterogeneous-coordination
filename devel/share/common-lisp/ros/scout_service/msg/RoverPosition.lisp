...
(cl:defmethod cl:initialize-instance :after ((m <RoverPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RoverPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scout_service-msg:<RoverPosition> is deprecated: use scout_service-msg:RoverPosition instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RoverPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_service-msg:header-val is deprecated.  Use scout_service-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'rover_name-val :lambda-list '(m))
(cl:defmethod rover_name-val ((m <RoverPosition>))
...
(cl:defmethod x-val ((m <RoverPosition>))
...
(cl:defmethod y-val ((m <RoverPosition>))
...
(cl:defmethod z-val ((m <RoverPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_service-msg:z-val is deprecated.  Use scout_service-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RoverPosition>)))
  ...
  "de1caca4779cb70d04d3cdea86bec142")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RoverPosition)))
  "Returns md5sum for a message object of type 'RoverPosition"
  "de1caca4779cb70d04d3cdea86bec142")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RoverPosition>)))
  ...
  (cl:format cl:nil "Header      header~%string      rover_name~%float64     x~%float64     y~%float64     z~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RoverPosition)))
  "Returns full string definition for message of type 'RoverPosition"
  (cl:format cl:nil "Header      header~%string      rover_name~%float64     x~%float64     y~%float64     z~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
